...
- Medium/high work: `skills/stage.md` — the staged loop to closeout; touch-up/low skip it.
...
- Parallel work, competing candidates, or a requested agent count: `skills/topology.md`; authority adds `skills/model-capabilities.md`.
...
- UI: `skills/ui-ux.md`; distinctive/slop-risk work adds `skills/taste.md`; token changes add `skills/design.md`. Tooling/new surface: `skills/stack.md`.
...
- Learning from a codebase you don't own: `skills/codebase-deep-scan.md`.
- Live pairing: reviewer loads `skills/pair.md`; implementation owner loads `skills/pair-reviewer.md`.

Start exploration at `docs/wiki/index.md`; follow the links you need.
